...
function spamshield_get_anchortxt_blacklist() {
	$blacklist_keyphrases = array( // 507
		...
		"erectile", "erection", "erotic", "eroticism", "escort service", "european", "evasion", "executive", "exercise", "exterminator", "extract", "extreme", "eyeglasses", "fabric", "facebook", "family", "female", 
		...
		"minnesota", "mississippi", "missouri", "mistake", "mobilabonnement priser", "modern", "modulesoft", "monster", "montaigne", "montre", "mortal", "movie", "moving", "muscle", "naked", "nashville", "natural", 
		...
		"vigara", "vigrx", "vintage", "visit now", "volume", "voucher", "watches", "wayfarer", "web page", "web site", "webmaster", "weight loss", "weightless", "west virginia", "wholesale", "wicked", "wisconsin", 
